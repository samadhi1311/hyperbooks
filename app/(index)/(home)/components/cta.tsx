...
export default function CTA() {
	return (
		<Section className='relative'>
			...
			<div className='absolute bottom-0 -z-50 h-full w-full bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-foreground/10 via-transparent to-transparent dark:from-foreground/10 dark:via-transparent dark:to-transparent' />
		</Section>
	);
}
