...
export function GridPattern({ width = 40, height = 40, x = -1, y = -1, strokeDasharray = '0', squares, className, ...props }: GridPatternProps) {
	...
	return (
		<svg
			aria-hidden='true'
			className={cn('pointer-events-none absolute inset-0 h-full w-full fill-neutral-600/10 stroke-neutral-600/20 dark:fill-neutral-400/10 dark:stroke-neutral-400/20', className)}
			{...props}>
			<defs>
