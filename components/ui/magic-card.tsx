...
export function MagicCard({ children, className, gradientSize = 200, gradientColor = '#262626', gradientOpacity = 0.8 }: MagicCardProps) {
	...
	return (
		<div
			ref={cardRef}
			className={cn('group relative flex size-full rounded-lg overflow-hidden bg-neutral-50/80 dark:bg-neutral-900/50 border border-border text-black dark:text-white', className)}>
